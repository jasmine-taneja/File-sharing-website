...
function Header() {
  ...
  <Image src="/logo.svg" width={50} height={50} alt="Company Logo" />
    ...
    <div className="flex flex-1 items-center justify-end md:justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          className="block rounded-sm bg-grey-100 p-2.5 text-gray-600 transition hover:text-teal-600/75 md:hidden"
        >
